            ...
            <div class="box">
              ...
              <div class="box-body table-responsive no-padding">
                <table class="table table-hover">
                  ...
                  <?php $get_all_posts = getJson('db.post' , true) ; ?>
                  <?php foreach($get_all_posts as $key => $post) : ?>
                    <?php $situation = getPostSituation($post['situation']) ;?>
                  <tr>
                    <td><?=($key + 1) ;?></td>
                    <td><?=$post['auther'] ;?></td>                   
                    <td><span class="label label-<?= $situation[1] ;?>"><?= $situation[0] ;?></span></td>
                    <td><?=substr($post['body'] , 0 , 50) ;?>
                    <td><?=date('Y-m-d' , $post['date']) ;?></td>
                    </td>
                  </tr>
                  <?php endforeach ;?>
                </tbody></table>
