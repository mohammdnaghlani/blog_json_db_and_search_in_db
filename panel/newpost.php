...
require_once $root_path . 'bootstrap' . DIRECTORY_SEPARATOR . 'init.php' ;
$error =array();
$success =array();
$form_names =array('auther' , 'body' , 'situation');
$required = array('auther' , 'body' , 'situation');
if(isset($_POST['submit'])){
    foreach($form_names as $key => $name){
      if(in_array($name , $required)){
        $data_form = trim($_POST[$name]) ;
        if(!empty($data_form)){
          $success[$name] = $data_form ;
        }else{
...
if(empty($error) && !empty($success)){
  $success['date'] = time() ;
  $insert_to_db = insertJson($success) ;
}
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            <a href="#"><i class="fa fa-link"></i> <span>مدیریت پست ها</span>
              <span class="pull-left-container">
                <i class="fa fa-angle-right pull-left"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li><a href="<?=url_link('panel/newpost.php')?>">افزودن پست جدید</a></li>
              <li><a href="<?=url_link('panel/list.php')?>">لیست پست ها</a></li>
            </ul>
          </li>
        </ul>
        <!-- /.sidebar-menu -->
            ...
            <div class="box-body">
              <form role="form" method="POST" action="">
                ...
                <div class="form-group">
                  <label>نویسنده</label>
                  <input type="text" class="form-control" placeholder="نویسنده" name="auther">
                </div>
                ...
                <div class="form-group">
                  <label>محتوا</label>
                  <textarea class="form-control" rows="6" placeholder="متن" name="body"></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="situation">
                      <option></option>
                      <option value="1">متشر شده</option>
                      <option value="2">در انتظار تایید</option>
                      <option value="3">پیشنویس</option>
                      <option value="4">غیر قابل انتشار</option>                     
                    </select>
                  </div>
